<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <span class="menu-text fw-bolder ms-2 fs-4">ITman</span>
        </a>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('module.index') }}" class="menu-link">
                        <div data-i18n="Without menu">Module List</div>
                    </a>
                </li>
                <li class="menu-item">
    ...
    <ul class="menu-sub">
        ...
        <li class="menu-item">
            <a href="{{ route('settings.apperance') }}" class="menu-link">
                <div data-i18n="Without menu">Apperance Setting</div>
            </a>
        </li>

        <li class="menu-item">
            <a href="{{ route('settings.mail') }}" class="menu-link">
                <div data-i18n="Without menu">Mail Setting</div>
            </a>
        </li>
