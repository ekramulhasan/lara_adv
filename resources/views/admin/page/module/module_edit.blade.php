...
<div class="row">
    ...
    <div class="col">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('module.update', $module_name->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="basic-default-fullname" placeholder="Enter Module Name" name="module_name" value="{{ $module_name->module_name }}">
