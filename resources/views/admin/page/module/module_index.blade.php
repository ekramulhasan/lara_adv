...
<div class="card">
    ...
    <div class="d-flex justify-content-between align-items-center my-2">
        ...
        <h5 class="card-header">Module Index / Module List</h5>
    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-hover">
        ...
        <tbody class="table-border-bottom-0">
            ...
            @forelse ($module_data as $value)

            <tr>
                <td><strong>{{ $value->id }}</strong></td>
                <td>{{ $value->module_name }}</td>
                <td>{{ $value->module_slug }}</td>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" style="">
                      <a class="dropdown-item" href="{{ route('module.edit',$value->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>

                      <form action="{{ route('module.destroy',$value->id) }}" method="post">
                        @csrf
                        @method('DELETE')
