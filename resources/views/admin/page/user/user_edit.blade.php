...
<div class="row">
    ...
    <div class="col">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('user.update',$user_update->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror" aria-label="Default select example" name="role_id">
                                ...
                                @foreach ($role_data as $value)
                                    <option value="{{ $value->id }}" @if ($value->id == $user_update->role_id)
                                        selected
                        ...
                        @enderror" id="basic-default-fullname" placeholder="Enter User Name" name="user_name" value="{{ $user_update->name }}">
                        ...
                        @enderror" id="basic-default-fullname" placeholder="Enter User Email" name="user_email" value="{{ $user_update->email }}">
