            ...
            <div class="card-body">
                <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="basic-default-fullname" placeholder="Enter role Name" name="role_name">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="basic-default-fullname" placeholder="Enter role Note" name="role_note">
                                ...
                                <div class="col">
                                    ...
                                    {{-- select permission --}}
                                        ...
                                        <div class="form-check justify-content-center mb-3">
                                            ...
                                            value="{{ $item->id }}"
                                            name="items[]"
                                            id="permission-{{ $item->id }}"> {{ $item->permission_name }}
                                          </div>
